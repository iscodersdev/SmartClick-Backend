...
namespace DAL.Migrations
{
    ...
    [Migration("20231218135937_mig65")]
    partial class mig65
    {
            ...
            modelBuilder.Entity("DAL.Models.Prestamos", b =>
                {
                    ...
                    b.Property<int?>("DomicilioLocalidadId");

                    b.Property<int?>("DomicilioPaisId");

                    b.Property<int?>("DomicilioProvinciaId");
                    ...
                    b.HasIndex("DomicilioLocalidadId");

                    b.HasIndex("DomicilioPaisId");

                    b.HasIndex("DomicilioProvinciaId");
            ...
            modelBuilder.Entity("DAL.Models.Prestamos", b =>
                {
                    ...
                    b.HasOne("DAL.Models.Localidad", "DomicilioLocalidad")
                        .WithMany()
                        .HasForeignKey("DomicilioLocalidadId");

                    b.HasOne("DAL.Models.Paises", "DomicilioPais")
                        .WithMany()
                        .HasForeignKey("DomicilioPaisId");

                    b.HasOne("DAL.Models.Provincia", "DomicilioProvincia")
                        .WithMany()
                        .HasForeignKey("DomicilioProvinciaId");
