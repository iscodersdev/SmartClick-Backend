...
{
    // DTOs para autenticaci�n y token
    ...
    {
        public int entityTypeId { get; set; } = 5; // Persona F�sica
    ...
    public class CreateUserRequestDTO
    {
        ...
        public string userName { get; set; }                  // Nombre de usuario �nico
        public string documentType { get; set; } = "CUIL";    // Tipo de documento
        public string documentNumber { get; set; }            // N�mero de documento
        public string firstName { get; set; }                 // Nombre
        public string lastName { get; set; }                  // Apellido
        public string email { get; set; }                     // Email
        public string phoneNumber { get; set; }               // Tel�fono
        public string address { get; set; }                   // Direcci�n
        ...
        public string passwordConfirm { get; set; }           // Confirmaci�n contrase�a
    }
    ...
    public class SelfRegistrationRequestDTO
    {
        ...
        public bool isPhysicalPerson { get; set; } = false;      // Es persona f�sica
        ...
        public string phoneCode { get; set; } = "549";           // C�digo tel�fono
        ...
        public string postalCode { get; set; }                   // C�digo postal
        public string email { get; set; }                        // Email
        public bool isRevalidation { get; set; } = true;         // Es revalidaci�n
        public bool IsSameAddress { get; set; } = true;          // Misma direcci�n
        public string activityPostalCode { get; set; }           // CP actividad
        public int activityCityId { get; set; } = 3;             // Ciudad actividad
        public string activityAddress { get; set; }              // Direcci�n actividad
        public string activityFloor { get; set; }                // Piso actividad
        public string activityDepartment { get; set; }           // Depto actividad
        public string FantasyName { get; set; }                  // Nombre fantas�a
        public string cuf { get; set; }                          // CUF
        public string CovenantCode { get; set; }                 // C�digo convenio
    }
    ...
    public class SelfRegistrationResponseDTO
    {
        public bool Success { get; set; }
        public string Message { get; set; }
        public string Identifier { get; set; }  // ID para subir archivos despu�s
        public string EntityId { get; set; }
        public string Error { get; set; }
    }
    ...
    {
        public string UAT { get; set; }  // Token de autenticaci�n del usuario administrador
    }
    ...
    /// <summary>
    /// DTO para la informaci�n de cuenta del usuario (mapea respuesta del PSP)
    /// </summary>
    ...
    /// <summary>
    /// DTO para la respuesta del controlador API (incluye UAT y campos de respuesta est�ndar)
    /// </summary>
    ...
    /// <summary>
    /// Request DTO para validar cuenta externa v�a PSP desde endpoint interno
    /// </summary>
    public class ValidateExternalAccountRequestDTO : PSPBaseResponseDTO
    {
        public string TextSearch { get; set; }
        public string UserToken { get; set; } // optional: token del usuario PSP para hacer la validaci�n en contexto del usuario
    }
    ...
    /// <summary>
    /// Request DTO para crear transacci�n con UAT
    /// </summary>
    ...
    /// <summary>
    /// Response DTO para crear transacci�n con UAT
    /// </summary>
