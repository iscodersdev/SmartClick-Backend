...
namespace BusinessCore.Services
{
    public interface IPSPService
    {
        ...
        /// <summary>
        /// Crea una transacci�n (transferencia) en el PSP. El userToken debe ser el token del usuario que autoriza la transferencia.
        /// Se puede pasar localCuit para evitar consultar las cuentas del PSP cuando ya se valid� localmente.
        /// </summary>
        ...
        /// <summary>
        /// Solicita al PSP recuperar la contrase�a (env�a EventValidator al usuario)
        /// </summary>
        Task<SimplePspResponseDTO> RecoverPasswordAsync(RecoverPasswordRequestDTO request, string systemToken);

        /// <summary>
        /// Resetea la contrase�a en el PSP usando EventValidator
        /// </summary>
